    ...
    <Layout>
      ...
      <div className="flex flex-row flex-wrap justify-center gap-6 py-8">
        {venueList.map((venue) => (
          <div
            key={venue.venue_id}
            className="border border-gray-200 max-w-[300px] min-h-[450px] rounded-lg flex flex-col overflow-hidden shadow-sm"
          >
...
<div className="p-6 flex flex-col justify-between flex-grow">
  <div>
    ...
    <div className="min-h-[140px]">
      <p className="text-gray-500 text-sm mb-2 line-clamp-3">{venue.venue_desc}</p>
  ...
  <Button className="w-full bg-black text-white mt-auto mt-6">View Details & Book</Button>
</div>
